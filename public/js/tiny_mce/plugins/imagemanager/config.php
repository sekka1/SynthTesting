<?php
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mp4,mpeg,asf,flv";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,mp4,mpg";
	...
	// Authenication
      	$mcImageManagerConfig['authenticator'] = ""; // Disabled MRR20121112
