 ...
 */
class Customers extends \AlgorithmsIO\Entity\Customers implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'longName', 'created', 'last_modified', 'roles', 'attributes');
    }
