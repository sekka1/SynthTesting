 ...
 */
class Flows extends \AlgorithmsIO\Entity\Flows implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'type', 'version', 'description', 'defaultCost', 'defaultCostMethod', 'published', 'flowData', 'created', 'last_modified', 'user', 'jobs', 'attributes');
    }
