...
class Users extends \AlgorithmsIO\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::has_role($rolename);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'firstName', 'lastName', 'username', 'password', 'created', 'last_modified', 'roles', 'dashboards', 'created_datasources', 'created_visualizations', 'created_flows', 'created_algorithms', 'created_jobs', 'attributes');
    }
