 ...
 */
class Visualizations extends \AlgorithmsIO\Entity\Visualizations implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'type', 'version', 'description', 'default_cost', 'default_cost_method', 'published', 'visualization_data', 'created', 'last_modified', 'user', 'attributes', 'jobs');
    }
